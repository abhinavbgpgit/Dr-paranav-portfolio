...
import logo from '../assets/logo/physiotherapy_logo.png'
     ...
     <div className="bg-white shadow-md rounded-lg p-4 mt-16 h-[600px] relative min-w-[250px]">
      ...
      />
       ...
       <img
        src={logo}
        alt="Dr. Robert Gibbons"
        className=" h-12 object-cover mb-4 absolute  left-[10px] top-[270px]"
      ...
      <ul className=" ml-5">
        ...
        <li className=" border-l-2 flex items-center bg-red-300 py-2 relative">
        <span className="absolute top-0 left-[-5px] inline-block bg-blue-500 rounded-full w-3 h-3 mr-2 relative">
  <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-full w-2 h-2"></span>
</span>
          <span className="font-semibold text-xs ml-[-5px]">Name : </span><span className=" text-xs ml-1"> Pranav Kumar</span> 
        </li>
        ...
        <li className="flex items-center">
          <span className="inline-block bg-blue-500 rounded-full w-3 h-3 mr-2"></span>
          <span className="font-semibold text-xs">Job :</span>
        ...
        <li className="flex items-center">
          <span className="inline-block bg-blue-500 rounded-full w-3 h-3 mr-2"></span>
          <span className="font-semibold text-xs">Skype :</span>
